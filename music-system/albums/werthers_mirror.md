# 🪞 베르테르의 거울 (Werther's Mirror)
## 10-Track Concept Album — Reason Moon Suno Composer

> **컨셉 테제:** "나를 사랑해야 남을 사랑할 수 있다"는 거짓말이었다.
> 당신을 사랑한 후에야, 비로소 나를 사랑하게 되었다.

---

# Album Concept

- **Album Title:** 베르테르의 거울 (Werther's Mirror)
- **Tagline:** 당신이라는 거울 앞에서, 나는 처음으로 나를 보았다
- **Theme Sentence:** 타인에 대한 사랑이 자기 발견의 거울이 되는 순간들을 10곡에 걸쳐 고백하는 서사 앨범
- **Theme Keywords:** 거울, 발견, 고백, 반사, 성장
- **Sound Palette:** Ethereal Art Pop / Indie Folk / Alternative Rock / Neo-Soul / Cinematic / Dream Pop — 트랙마다 장르가 달라지되, 리버브 깊이와 피아노 텍스처로 일관성 유지
- **Energy Curve:** `[2, 3, 4, 3, 2, 3, 4, 5, 5, 2]`
...
## Track 04 — "부드러운 연습" (Practicing Tenderness)
- **Intent:** 당신이 나에게 했던 것처럼, 나도 나에게 부드러워지는 연습
- **Energy:** 3
- **Variation Axis:** 자기 돌봄 학습 / 부드러움
- **Genre:** Neo-Soul + R&B

### Suno Style Prompt
```
Warm female vocal with soulful runs / neo-soul × contemporary R&B, 84 BPM, 4/4 laid-back groove, A-flat major with jazz extensions and ninth chords, Rhodes electric piano plays smooth gospel-influenced chord voicings with tremolo, fingerstyle bass guitar provides a deep warm walking groove, programmed drums play a head-nod pattern with soft kick and crispy hi-hat, muted trumpet provides occasional breathy countermelody lines, backing vocals support soft ooh-aah harmonies on chorus, vocal texture is rich and warm chest voice with control runs and gentle melisma, delivery conveys learning and self-compassion with tender authority, phrasing sits comfortably in the pocket with subtle syncopation, intimate close-mic mix with warm low-mids emphasis, short plate reverb on vocal, analog tape warmth throughout, bass prominent in mix center
```
**Char Count:** 768

### Suno Lyrics
```
[Verse 1 | Vocals: Warm Chest | Rhodes Piano | Energy: Medium-Low]
넌 내 손에 밴드를 붙여줬어
아무렇지 않게, 당연하다는 듯
그 작은 손길이 알려줬어
나도 나를 이렇게 대할 수 있다고
...
## Track 10 — "나라는 계절" (The Season Called Me)
- **Intent:** 에필로그 — 당신이 떠나도, 당신 덕분에 피어난 나는 남는다
- **Energy:** 2
- **Variation Axis:** 평화 / 독립 / 순환
- **Genre:** Ambient Pop + Piano Epilogue

### Suno Style Prompt
```
Solo female vocal with breath sounds audible / ambient pop × minimalist piano epilogue, 60 BPM, free time feel with gentle rubato, F major with lydian brightness, solo grand piano plays simple chordal movement with long sustain and natural decay, soft ambient pad provides barely audible harmonic support, distant wind chimes play random gentle accents like a breeze, nature field recording provides subtle birdsong atmosphere underneath, vocal texture is completely natural unprocessed and intimate as if sitting beside the listener, delivery is peaceful and settled with no tension or urgency, phrasing is completely free and unhurried with natural breathing audible, extremely intimate recording with almost no reverb on vocal creating closeness, piano has natural room ambience, very quiet mix with dynamic subtlety, warm analog character throughout, the gentlest possible ending
```
**Char Count:** 754

### Suno Lyrics
```
[Intro | Solo Piano | Energy: Minimal | Mood: Morning After Everything]
...
## Style Prompt Gate
| Track | Chars | 한 줄 | 5요소 | 라벨 없음 | 동사(plays/provides/supports) |
|-------|-------|-------|-------|-----------|------------------------------|
| 01 | 712 | ✓ | ✓ | ✓ | plays, provides, supports, plays, provides |
| 02 | 731 | ✓ | ✓ | ✓ | plays, provides, plays, supports, plays |
| 03 | 789 | ✓ | ✓ | ✓ | plays, provides, play, supports, plays |
| 04 | 768 | ✓ | ✓ | ✓ | plays, provides, play, provides, support |
| 05 | 808 | ✓ | ✓ | ✓ | plays, provides, provides, plays, plays |
| 06 | 796 | ✓ | ✓ | ✓ | plays, plays, provide, plays, provides |
| 07 | 808 | ✓ | ✓ | ✓ | plays, provides, plays, plays, provides |
| 08 | 839 | ✓ | ✓ | ✓ | plays, plays, provides, play, plays |
| 09 | 835 | ✓ | ✓ | ✓ | plays, provides, plays, provides, plays |
| 10 | 754 | ✓ | ✓ | ✓ | plays, provides, play, provides |
| **All** | **712-839** | **10/10** | **10/10** | **10/10** | **All ≥ 3** ✓ |

## Energy Curve Verification
```
설계: [2, 3, 4, 3, 2, 3, 4, 5, 5, 2]
실제: [2, 3, 4, 3, 2, 3, 4, 5, 5, 2] ✓
...
03: 발견 (당신 눈에 비친 나)           ← 상승
04: 학습 (부드러움을 배우다)
05: 자기 고백 (나에게 쓰는 편지)       ← 내면 전환
06: 성장 (거울의 정원)
07: 공포 (사라질까 봐)                ← 갈등
08: 자립 (내 이름으로 서는 법)         ← 클라이맥스 시작
09: 고백 (베르테르의 테제)             ← 최고조
10: 평화 (나라는 계절)                ← 에필로그
```
