...
- [ ] Prompt is one line.
- [ ] Prompt length in target range (`450-999` for album tracks).
- [ ] Prompt includes 5 elements (Identity/Mood/Instruments/Performance/Production).
- [ ] Instrument action verbs `plays/provides/supports` are present.
- [ ] No artist-name style mimicry.
