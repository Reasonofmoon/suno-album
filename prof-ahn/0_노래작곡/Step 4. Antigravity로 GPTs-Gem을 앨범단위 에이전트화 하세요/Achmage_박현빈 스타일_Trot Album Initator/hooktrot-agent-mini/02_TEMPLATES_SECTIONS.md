...
****************************************
[9] ALBUM SEQUENCING TEMPLATES (신규)
****************************************

목적
- 한 곡 템플릿 모음을 “앨범 시퀀스 설계”까지 확장한다.

[9-1] 6트랙 기본 시퀀스
- T01 Opener: FORM_02 (짧은 인트로, 즉시 훅)
- T02 Title Track: FORM_01 또는 FORM_03 (콜&리스폰스 최대화)
- T03 Variation A: FORM_05 (밝은 감정/톤 전환)
- T04 Variation B: FORM_06 (도시 질감, 트로트 리듬 유지)
- T05 Crowd Peak: FORM_03 또는 FORM_04 (훅 반복 증폭)
- T06 Finale: FORM_01 (더블훅 + 강한 라스트 히트)
